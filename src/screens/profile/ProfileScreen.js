...
const ProfileScreen = ({ navigation }) => {
  ...
  const { userData, user, logout, updateUser, deleteAccount } = useAuth();
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          ...
          {/* Edit Button can go here if needed */}
        </View>
        ...
        {stats && !editing && (
          <View style={styles.statsRow}>
            <Card style={styles.statCard}>
              <Text style={[styles.statVal, { color: colors.primary }]}>{stats.currentStreak} 🔥</Text>
              <Text style={[styles.statLbl, { color: colors.textSecondary }]}>Day Streak</Text>
            </Card>
            <Card style={styles.statCard}>
              <Text style={[styles.statVal, { color: colors.success }]}>{stats.jobReadiness}%</Text>
              <Text style={[styles.statLbl, { color: colors.textSecondary }]}>Readiness</Text>
            </Card>
            <Card style={styles.statCard}>
              <Text style={[styles.statVal, { color: colors.text }]}>{stats.totalStudyHours}h</Text>
