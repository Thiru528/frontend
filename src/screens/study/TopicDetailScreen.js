...
const TopicDetailScreen = ({ route, navigation }) => {
    ...
    console.log("TopicDetailScreen Loaded - Imports Safe"); // Force file update
    ...
    const loadTopicContent = async () => {
        try {
            ...
            const response = await studyAPI.generateTopicLesson(topic.title);
        ...
        return (
            <SafeAreaView style={[styles.container, { backgroundColor: colors.background, justifyContent: 'center', alignItems: 'center' }]}>
                ...
                <Text style={[styles.loadingText, { color: colors.textSecondary }]}>
                    Generating 5-Page AI Lesson for {topic.title}...
                </Text>
            </SafeAreaView>
        );
    }
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.navContainer}>
                    ...
                    {currentPage === content.pages.length - 1 ? (
                        <Button
                            title="Take Quiz ▶"
                            onPress={() => navigation.navigate('MCQArena', { topic: topic.title, dayNumber: topic.day })}
                            variant="primary"
