        ...
        {dashboardData?.dailyGoals && (
          <Card>
            ...
            <View style={styles.goalItem}>
              ...
              <ProgressBar
                progress={dashboardData.dailyGoals.studyTime.completed / dashboardData.dailyGoals.studyTime.target}
                label={`${dashboardData.dailyGoals.studyTime.completed}h / ${dashboardData.dailyGoals.studyTime.target}h`}
            ...
            <View style={styles.goalItem}>
              ...
              <ProgressBar
                progress={dashboardData.dailyGoals.mcqTests.completed / dashboardData.dailyGoals.mcqTests.target}
                label={`${dashboardData.dailyGoals.mcqTests.completed} / ${dashboardData.dailyGoals.mcqTests.target} completed`}
        ...
        <Card style={styles.quickActionsCard}>
          ...
          <View style={styles.quickActionsGrid}>
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('Study', { screen: 'TopicTimeline', params: { topic: 'JavaScript' } })}
            >
